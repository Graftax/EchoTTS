import { ApplicationCommandOptionBase, SlashCommandBuilder, SlashCommandIntegerOption, SlashCommandOptionsOnlyBuilder, SlashCommandStringOption, SlashCommandSubcommandBuilder } from "discord.js";
